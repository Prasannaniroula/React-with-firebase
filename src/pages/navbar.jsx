    ...
    <nav className="bg-black text-white h-16 p-4">
      <div className="flex justify-around">
        ...
        <div className="flex justify-center items-center text-md gap-5">
          <NavLink className="bg-blue-400 px-6 rounded-xl py-2 hover:bg-blue-500" to="/signin">Login</NavLink>
          <NavLink className="bg-blue-400 px-6 rounded-xl py-2 hover:bg-blue-500" to="/signup">Signup</NavLink>
        </div>
      </div>
    </nav>
  );
